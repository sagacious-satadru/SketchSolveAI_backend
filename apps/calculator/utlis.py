...
def analyze_image(img: Image, dict_of_vars: dict):
    ...
    Parameters:
    img (Image): The input image to be analyzed.
    dict_of_vars (dict): A dictionary of user-assigned variables and their values.
    ...
    prompt = (
        # f"YOU CAN HAVE FOUR TYPES OF EQUATIONS/EXPRESSIONS IN THIS IMAGE, AND ONLY FOUR:\n"
        # f"1. Simple mathematical expressions like 2+2, 3*4, 5/6, 7-8 etc.: Solve these step-by-step and provide the final answer.\n"
        # f"2. Systems of Equations like x^2 + 2x + 1 = 0, 3y + 4x = 0, 5x^2 + 6y + 7 = 12: Solve these systems using appropriate techniques and show the step-by-step work.\n"
        # f"3. Assignments of values to variables like x = 4, y = 5, z = 6 etc.: Identify the variables, retrieve their values from the provided dictionary, and use them in subsequent calculations.\n"
        # f"4. Graphical Math problems, like word problems represented in graphical form: Analyze the problem statement, set up the necessary equations or expressions, and solve them step-by-step.\n"
        # f"Analyze the equation or expression in this image and return the answer accompanied by a detailed, step-by-step explanation. Make sure to use extra backslashes for escape characters like \\f->\\\\f.\n"
        # f"Here is a dictionary of user-assigned variables, if given expression has any variables, use their actual values from this dictionary accordingly: {dict_of_vars_str}.\n"
        # f"PROPERLY QUOTE THE KEYS AND VALUES IN THE DICTIONARY FOR EASIER PARSING WITH JSON.LOADS()"
    ...
    # Call an external AI model to analyze the image and generate the response
